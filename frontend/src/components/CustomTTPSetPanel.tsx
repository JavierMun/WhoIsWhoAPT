...
import type { ActorComparisonResponse, CustomTTPSet, SimilarityMetric, TechniqueListItem } from "../api/types";
  ...
  return (
    <section className="comparison-workspace custom-workspace" aria-labelledby="custom-title">
      ...
      <div className="custom-layout">
        ...
        <CustomComparisonResults comparison={comparison} loading={comparing} />
      </div>
    </section>
  );
}

function CustomComparisonResults({ comparison, loading }: { comparison: ActorComparisonResponse | null; loading: boolean }) {
  if (loading) {
    return (
